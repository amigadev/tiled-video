...
player: out/player.o out/renderer.o out/tiles.o out/stream.o out/frames.o
	$(CC) -o $@ $^ $(LDFLAGS)

out/converter.o: src/converter.c src/renderer.h src/stream.h src/frames.h src/tiles.h
	$(CC) -c -o $@ $(CCFLAGS) $<

out/player.o: src/player.c src/renderer.h src/stream.h src/frames.h src/tiles.h
	$(CC) -c -o $@ $(CCFLAGS) $<
